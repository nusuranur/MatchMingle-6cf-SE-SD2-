...
// Fetch current user's preferences and gender
...
if ($sortBy == 'age') {
    ...
    $sql .= " ORDER BY TIMESTAMPDIFF(YEAR, birth_date, CURDATE()) DESC"; // Fallback
    // TODO: Implement real compatibility score logic
}
...
while ($row = mysqli_fetch_assoc($result)) {
    $row['compatibility_score'] = rand(50, 100); // Simulated score
    $matches[] = $row;
}
mysqli_stmt_close($stmt);
        ...
        <div class="container">
            ...
            if (empty($matches)) {
                ...
                foreach ($matchesPage as $match) {
                    ...
                    echo "<a href='send_interest.php?id={$match['id']}' class='btn'>Send Interest</a>";
