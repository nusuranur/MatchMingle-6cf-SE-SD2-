...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    // ekhane amra typically process the search (eg- query a database)
    // For this example, we'll just display the submitted data
    $search_message = " $looking_for  $age  $religion";
}
?>
...
<head>
    ...
    <style>
        body {
            ...
            padding-top: 0; /* Removed offset since navbar is no longer fixed */
        }
