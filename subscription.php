...
$pageTitle = "MatchMingle Subscription – Unlock Premium Features";
?>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="price">1098.9 bdt / month</p>
                            <ul class="feature-list">
                                <li><i class="fa fa-check"></i> View 10 Profiles Daily</li>
                                <li><i class="fa fa-check"></i> Send 5 Messages Weekly</li>
                                <li><i class="fa fa-check"></i> Basic Search Filters</li>
                            </ul>
                            <a href="payment.php?plan=basic&id=<?php echo $id; ?>" class="btn-action">Choose Plan</a>
                        </div>
                    </div>
                </div>
                <!-- Premium Plan -->
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="price">2198.9 bdt / month</p>
                            <ul class="feature-list">
                                <li><i class="fa fa-check"></i> Unlimited Profile Views</li>
                                <li><i class="fa fa-check"></i> Send Unlimited Messages</li>
                                <li><i class="fa fa-check"></i> Advanced Search Filters</li>
                                <li><i class="fa fa-check"></i> Priority Matching</li>
                            </ul>
                            <a href="payment.php?plan=premium&id=<?php echo $id; ?>" class="btn-action">Choose Plan</a>
                        </div>
                    </div>
                </div>
                <!-- Gold Plan -->
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="price">3298.9 bdt/ month</p>
                            <ul class="feature-list">
                                <li><i class="fa fa-check"></i> Unlimited Profile Views</li>
                                <li><i class="fa fa-check"></i> Send Unlimited Messages</li>
                                <li><i class="fa fa-check"></i> Advanced Search Filters</li>
                                <li><i class="fa fa-check"></i> Priority Matching</li>
                                <li><i class="fa fa-check"></i> Verified Badge</li>
                            </ul>
                            <a href="payment.php?plan=gold&id=<?php echo $id; ?>" class="btn-action">Choose Plan</a>
                        </div>
                    </div>
                </div>
            </div>
